    ...
    function get_equipments(unit, project){
        $.ajax({
            ...
            success:function(res){
                 //console.log(res);
                grafik_equipment("chart_equipment", res);
            }
        })
    }
    ...
    function grafik_equipment(div,datas){
        ...
        makeSeries("HEAT EXCHANGER", "heatExchanger", false);
        ...
        makeSeries("PIPING_SYSTEM", "pipingSystem", true);
        makeSeries("ROTATING", "rotatingSystem", true);
